...
HD_PWD='D:/FPGA/afisare_temperatura_i2c/afisare_temperatura_i2c.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_senzor_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_senzor_wrapper.tcl
