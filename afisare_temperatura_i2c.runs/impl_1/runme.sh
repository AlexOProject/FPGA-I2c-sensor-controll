...
HD_PWD='D:/FPGA/afisare_temperatura_i2c/afisare_temperatura_i2c.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log design_senzor_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source design_senzor_wrapper.tcl -notrace
